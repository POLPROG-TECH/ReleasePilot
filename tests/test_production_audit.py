"""Tests for production audit coverage.

Each test covers a specific area to prevent regression.
"""
...
# ═══════════════════════════════════════════════════════════════════════════════
# Markdown f-string nesting in _render_footer
# ═══════════════════════════════════════════════════════════════════════════════
...
class TestWebServerXSS:
    ...
    async def test_dashboard_error_escapes_exception(self):
        ...
        # Patch the dashboard generation to raise with HTML in the message
        with patch(
